...
export default function RedesUPAX() {
  ...
  return (
    <div style={{ minHeight:'100%', background:tab.bg, transition:'background 0.4s ease', fontFamily:'Inter,-apple-system,sans-serif' }}>
      <div style={{
        ...
        <div style={{ display:'flex', flexDirection:'column', alignItems:'flex-end', flexShrink:0, gap:3 }}>
          <div style={{
            ...
            <span style={{ width:6, height:6, borderRadius:'50%', background:tab.primary, display:'inline-block' }}/>
