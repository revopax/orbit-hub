...
export default function Overview({ udnNombre }: { udnNombre: string }) {
  return (
    <div style={{ padding: 20 }}>
      <div style={{ maxWidth: 1400, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <BloquePlaceholder
          ...
          subtitulo="Brand24 + Apollo - expansion, inversion y cambios de puesto detectados en tiempo real."
          fuente="bloque Senales de mercado (tab Mercado)"
        />
        <BloquePlaceholder
          numero={3}
          titulo="Calendario de prospeccion"
          subtitulo="Temporalidad por industria - mejor momento para contactar segun el ciclo economico."
          fuente="CalendarioGrid / Picos (tab Comercial)"
        />
        <BloquePlaceholder
          numero={4}
